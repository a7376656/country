...
class View
{
    ...
    public function __construct($engine = [], $replace = [])
    {
        ...
        $baseReplace = [
            ...
            '__STATIC__'    => $root . '/pubilc/static',
            '__CSS__'       => $root . '/public/static/css',
            '__JS__'        => $root . '/public/static/js',
            '__AVARAR__'    => $root . '/../home/img/upload',
            '__ICON__'      => $root . '/public/static/icons',
            '__BOOT__CSS__' => $root . '/public/bootstrap/css',
            '__BOOT__JS__'  => $root . '/public/bootstrap/js',
        ];
